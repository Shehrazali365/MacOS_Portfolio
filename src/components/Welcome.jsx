...
const setupTextHover = (container, type) => {
    ...
    const handleMouseleave = () => letters.forEach((letter) => animeteLetter(letter, base, 0.3));
...
const Welcome = () => {
    ...
    return (
        <section id='welcome' className=''>
            <p ref={subTitleRef}>{renderText("Hey, I'm Shehraz! Welcome to my", 'text-3xl font-georama', 100)}</p>
